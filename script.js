$(document).ready(function () {
  ...
  const animationScript = ["SOC Analyst","CyberSecurity Analyst", "CyberSecurity Professional"];
  ...
  $(".carousel").owlCarousel({
    margin: 20,
    loop: false, // Disable infinite loop to prevent cloning
    ...
    responsive: {
      ...
      600: {
        items: 2, // Set to 2 since there are only two cards
        nav: false,
      },
      1000: {
        items: 2, // Match the number of cards to avoid blank spaces
        nav: false,
      },
    },
  });
